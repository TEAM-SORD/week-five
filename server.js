...
// console.log( config.cKey  );
// console.log( config.cSecret  );
// console.log( config.atKey  );
// console.log( config.atSecret  );
...
//    // if there's data in filestream then send that back to the browser client first /////
    ...
    client.stream('statuses/filter', { track:'#chocolate, #cheese, #candy'}, function (stream) {
